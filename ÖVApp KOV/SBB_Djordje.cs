...
namespace ÖVApp_KOV
{
    public partial class Djordje : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            message.From = new MailAddress("djordjeaksentijevic007@gmail.com");
            message.To.Add(new MailAddress("djordjeaksentijevic007@gmail.com"));
        ...
        {
            //if (MessageBox.Show("Sie werden mit unserem Kompetentesten Mitarbeiter reden dürfen", "TopHilfe.Djordje", MessageBoxButtons.YesNo, MessageBoxIcon.Asterisk) == DialogResult.Yes)
